...
int main() {
	...
	rectanglep3 = new Rectangulo[2]{{2,5},{3,6}}; // Arreglo de rectants
	cout << "Area del rectangulo1: "<< rectangulo1.area()<< endl;
	cout << "Area del *rectanglep1:	"<< rectanglep1->area() << endl;
	cout << "Area del *rectanglep2: "<< rectanglep1->area() << endl;
	cout << "Area del rectanglep3[0]: "<< rectanglep3[0].area() << endl;
	cout << "Area del rectanglep3[0]: "<< rectanglep3[0].area() << endl;
